...
function Footer() {
  return (
    <div className="w-full h-screen flex bg-zinc-900 p-10 font-[fsm]">
      ...
      <div className='w-1/2'>
        ...
        <div className="dets font-[nmreal] mt-20">
        ...
        <div className="multilinks flex justify-between">
          <div className="dets font-[nmreal] mt-10">
              ...
              <div className="dets font-[nmreal] mt-10 font-thin">
                <p className='text-2xl mb-6'>E:</p>
                <a  className='block text-xl font-light' href="">202-1965 W 4th Ave</a>
              </div>
              <p className='mt-[2vw] font-[4vw]  text-zinc-700'>© ochi design 2024. Legal Terms</p>
          </div>
          <div className="dets font-[nmreal] mt-10">
              ...
              <p className='mt-[7vw] text-zinc-700'>Website by Obys</p>
          </div>
        </div>
      </div>
    </div>
