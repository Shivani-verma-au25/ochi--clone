...
function Footer() {
  return (
    <div data-scroll data-scroll-speed=".3" className="w-full h-screen flex bg-zinc-900 mt-20 font-[fsm]">
      <div className='w-1/2 h-full font-[fsm] flex flex-col justify-between'>
        ...
        <div className='w-1/2' >
          <h1 className='text-[8vw] font-[fsm]  uppercase leading-none -mb-10 '>Presentations</h1>
          <div className="dets font-[nmreal] mt-20 inline-block">
              <p className='text-2xl mb-6'>S:</p>
          ...
          <div className="multilinks flex justify-between">
            <d iv className="dets font-[nmreal] mt-10 inline-block">
                <p className='text-2xl mb-6'>L:</p>
                <a  className='block text-xl font-light' href="">202-1965 W 4th Ave</a>
                <a  className='block text-xl font-light mb-5' href="">Vancouver, Canada</a>
                <a  className='block text-xl font-light' href="">30 Chukarina St</a>
                <a  className='block text-xl font-light' href="">Lviv, Ukraine</a>
                <div className="dets font-[nmreal] mt-10 font-thin inline-block">
                  <p className='text-2xl mb-6'>E:</p>
                  <a  className='block text-xl font-light' href="">202-1965 W 4th Ave</a>
                </div>
                <p className='mt-4 font-[4vw]  text-zinc-700'>© ochi design 2024. Legal Terms</p>
            </d>
            <div className="dets font-[nmreal] mt-10 inline-block">
                <p className='text-2xl mb-6'>M:</p>
                ...
                <p className='mt-[7vw] pr-[1vw] text-zinc-700'>Website by Obys</p>
            </div>
          </div>
        </div>
    </div>
